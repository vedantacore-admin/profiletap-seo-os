...
You are generating an SEO content brief for [PROJECT_NAME], a [product description].
...
- frame [PROJECT_NAME] as a smart identity platform, not only as an NFC card tool
...
- category definition
- benefits
- how [PROJECT_NAME] works in that hub context
- use-case examples
- CTA
...
- [PROJECT_NAME] use cases for that audience
